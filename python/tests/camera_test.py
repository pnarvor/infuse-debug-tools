...
axes[0].plot(navData.stereoDesync / 1000.0, label="Nav Stereo desync")
axes[0].legend(loc="upper right")
axes[0].set_xlabel("Image index")
axes[0].set_ylabel("Desync (ms)")
axes[0].grid()
# axes[1].plot(navData.disparityScore, label="Nav disparity score")
axes[1].plot(navData.disparityScoreFiltered, label="Nav disparity score filtered")
axes[1].legend(loc="upper right")
axes[1].set_xlabel("Image index")
axes[1].set_ylabel("% unpaired pixels")
axes[1].grid()
axes[2].plot(navData.leftIntegrity, label="Nav left integrity")
axes[2].plot(navData.rightIntegrity, label="Nav right integrity")
axes[2].legend(loc="upper right")
axes[2].set_xlabel("Image index")
axes[2].set_ylabel("Image integrity (?)")
axes[2].grid()
axes[3].plot(navData.totalScore, label="Nav total score")
