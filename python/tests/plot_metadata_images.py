...
sync = ImageSynchronizer("/media/M3-data1/M3-mission/minnie/log_data_acquisition_2018_12_02_13_42_55/raw_data/")
...
out_file = open("/media/M3-data1/M3-mission/minnie/log_data_acquisition_2018_12_02_13_42_55/raw_data/good_pairs.txt", "w")
for pair in sync.iSynchedNavStamps:
